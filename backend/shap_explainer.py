...
class ShapExplainer:
    ...
    def __init__(self, ensemble_engine):
        ...
        uci_train_path = os.path.join(
            os.path.dirname(os.path.dirname(__file__)), 'data', 'uci_train.pkl'
        )
...
def generate_threat_matrix(url: str) -> list:
    ...
    if _explainer is None:
        ...
        _explainer = ShapExplainer(_ensemble_mod.engine)
    return _explainer.generate_threat_matrix(url)
